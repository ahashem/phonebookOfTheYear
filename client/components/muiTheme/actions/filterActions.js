export const CRUD_SHOW_FILTER = 'MUI_THEME/CRUD_SHOW_FILTER';
export const CRUD_HIDE_FILTER = 'MUI_THEME/CRUD_HIDE_FILTER';
export const CRUD_SET_FILTER = 'MUI_THEME/CRUD_SET_FILTER';
