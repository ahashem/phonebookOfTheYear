...
// import Notification from './Notification'; that will come later
import defaultTheme from '../defaultTheme';
import { setSidebarVisibility as setSidebarVisibilityAction } from '../actions';

injectTapEventPlugin(); // Tap event management - Just in case
        ...
        <div style={prefixedStyles.wrapper}>
          <div style={prefixedStyles.main}>
            ...
            >
              ...
              >
                {/* TODO: add route guards or Auth. props*/}
                <ThemeRoutes
...
function mapStateToProps(state) {
  return {
    // isLoading: state.muiTheme.loading > 0,
  };
}
